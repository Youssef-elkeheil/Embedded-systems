...
void MEXTI_voidEXTI0Init(void (* ptr_ISR0FunctionLogic)(void))
{
	MDIO_voidSetPinDirection(INT0_PORT,INT0_PIN,OUTPUT);
	MDIO_voidSetPinValue(INT0_PORT,INT0_PIN,HIGH);
...
void MEXTI_voidEXTI1Init( void (* ptr_ISR1FunctionLogic) (void) )
{
	MDIO_voidSetPinDirection(INT1_PORT,INT1_PIN,OUTPUT);
	MDIO_voidSetPinValue(INT1_PORT,INT1_PIN,HIGH);
...
void MEXTI_voidEXTI2Init(void (* ptr_ISR2FunctionLogic)(void))
{
	MDIO_voidSetPinDirection(INT2_PORT,INT2_PIN,OUTPUT);
	MDIO_voidSetPinValue(INT2_PORT,INT2_PIN,HIGH);
